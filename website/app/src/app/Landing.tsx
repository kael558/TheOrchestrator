  ...
  const features = [
    {
      ...
      description: 'Simply provide input-output pairs and let OptiTune handle the rest. No complex prompt engineering required.'
    },
    {
      icon: CogIcon,
      title: 'Automated System Prompts',
      description: 'Our AI automatically generates optimal system prompts and code based on your test cases.'
    },
    {
      icon: CurrencyDollarIcon,
      title: 'Cost Optimization',
      description: 'Automatically selects the best model balancing accuracy and pricing so you never overpay.'
    },
    {
      icon: ShieldCheckIcon,
      title: 'Quality Monitoring',
      description: 'Continuous monitoring detects model downgrades and automatically switches or fixes issues.'
    },
    {
      icon: LightningBoltIcon,
      title: 'Simple API',
      description: 'One endpoint, just like any LLM API. Send parameters, get responses. No complexity.'
    },
    {
      icon: ChartBarIcon,
      title: 'Performance Tracking',
      description: 'Track accuracy, cost, and performance across all your tests and model iterations.'
    }
  ];
  ...
  const promptEngineeringComparisons = [
    {
      ...
      orchestrator: 'Provide examples, get optimized prompts automatically'
    },
    {
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="text-2xl font-bold text-gray-900">
              The<span className="text-primary">Orchestrator</span>
            </div>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-gray-100 py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            TheOrchestrator automatically optimizes your LLM usage by selecting the best model for accuracy and cost, 
            monitoring for downgrades, and maintaining quality - all through one simple API.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <form onSubmit={handleWaitlistSubmit} className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <input
                type="email"
          ...
          {isSubmitted && (
            <p className="text-green-600 mt-4 animate-fadeIn">
              🎉 You're on the golden waitlist! Get ready for exclusive early access to TheOrchestrator.
            </p>
          )}
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              From input-output pairs to production-ready API in minutes
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Stop wasting hours on prompt crafting. TheOrchestrator eliminates the guesswork and automates the entire prompt optimization process.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
              <div className="bg-white p-8 rounded-xl shadow-lg border-l-4 border-red-500">
                ...
                <ul className="space-y-4">
                  {promptEngineeringComparisons.map((item, index) => (
                ...
                <ul className="space-y-4">
                  {promptEngineeringComparisons.map((item, index) => (
                    <li key={index} className="flex items-start">
                      ...
                      <span className="text-gray-700">{item.orchestrator}</span>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            <div className="bg-gradient-to-r from-primary to-primary-dark text-white p-8 rounded-xl text-center">
              ...
              <p className="text-xl opacity-90 mb-6">
                What used to take weeks of prompt engineering now happens automatically in minutes.
              </p>
              <div className="flex justify-center items-center space-x-8 text-lg">
                ...
                <div className="text-center">
                  ...
                  <div className="opacity-75">Better Results</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold">Zero</div>
                  <div className="opacity-75">Manual Work</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Manual model management</span>
                  <span className="text-red-500 font-semibold">20+ hours/month</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Model downgrade detection</span>
                  <span className="text-red-500 font-semibold">Days to notice</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Cost optimization</span>
                  <span className="text-red-500 font-semibold">Manual analysis</span>
                </div>
                <hr />
                <div className="flex justify-between items-center text-lg">
                  <span className="text-gray-900 font-semibold">With TheOrchestrator</span>
                  <span className="text-green-500 font-bold">Fully Automated</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-primary">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl mx-auto">
            Join the golden waitlist and be among the first to experience intelligent LLM optimization with exclusive early access.
          </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Intelligent LLM optimization for modern developers.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 TheOrchestrator. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
