...
const sharedPayloadParams = {
  "system_message": {
    "description": "The system message to be used as instructions and context for the conversation",
    "type": "string",
  ...
  "messages_with_system": {
    ...
    "type": "array",
    "value": [
      { "role": "system", "content": "The system message to be used as instructions and context for the conversation" },
  ...
  "top_k": {
    ...
    "minimum": 0.0,
    "maximum": 1.0,
    "description": "The number of highest probability vocabulary tokens to keep for top-k sampling. Higher values make the model more deterministic."
  },
  "top_p": {
    "type": "number",
    "minimum": 0.0,
...
configurations["Claude 2.1"] = {
  "metadata": {
    ...
    "provider": "Anthropic",
    "developer": "Anthropic",
    "description": "An updated version of Claude 2 with improved accuracy and consistency",
    "cost": {
      "input": 8,
      "output": 24
    }
  ...
  "request": `{
      ...
      "payload": {
        "model": "claude-2.1",
        "system": {{{ jsonify system_message }}},
        "messages": [{{#each messages}}{"role":"{{this.role}}","content": {{{ jsonify this.content}}} }{{#unless @last}}, {{/unless}}{{/each}}],
        "stop_sequences": [{{#each stop_sequences}}"{{this}}"{{#unless @last}}, {{/unless}}{{/each}}],
...
configurations["Claude 3 Haiku"] = {
  "metadata": {
    ...
    "provider": "Anthropic",
    "developer": "Anthropic",
    "description": "Haiku is the fastest and most cost-effective model for its intelligence category from the Anthropic family of models.",
    "cost": {
      "input": 0.25,
      "output": 1.25
    }
...
configurations["Claude 3 Opus"] = {
  "metadata": {
    ...
    "provider": "Anthropic",
    "developer": "Anthropic",
    "description": "Opus is the most powerful, delivering state-of-the-art performance on complex tasks from the Anthropic family of models.",
    "cost": {
      "input": 15,
      "output": 75
    }
...
configurations["GPT 3.5 Turbo"] = {
  ...
  "request": `{
    ...
    "payload": {
      "model": "gpt-3.5-turbo",
      "messages": [{{#each messages}}{"role":"{{this.role}}","content":"{{this.content}}"}{{#unless @last}},{{/unless}}{{/each}}],
      "temperature": {{temperature}},
      "top_p": {{top_p}},
      "max_tokens": {{max_tokens}},
      ...
      "max_tokens": {{max_tokens}},
      "stop": [{{#each stop_sequences}}"{{this}}"{{#unless @last}},{{/unless}}{{/each}}]
    },
    "keysToResult": [
      "choices",
      0,
...
configurations["GPT4"] = {
  ...
  "request": `{
    ...
    "payload": {
        ...
        "messages": [
            {{#each messages}}
            { "role": "{{this.role}}", "content": {{{jsonify this.content}}} }{{#unless @last}},{{/unless}}
            {{/each}}
        ],
        "stop": [{{#each stop_sequences}}"{{this}}"{{#unless @last}}, {{/unless}}{{/each}}],
        "temperature": {{temperature}},
...
// Llama 3.1 70B Versatile configuration
configurations["Llama 3.1 70B Versatile"] = {
  "metadata": {
    "name": "Llama 3.1 70B Versatile",
    "provider": "Groq",
    "developer": "Meta",
    "description": "A versatile model with a large context window for complex tasks.",
...
configurations["Llama 3.1 8B Instant"] = {
  "metadata": {
...
configurations["Gemma 7B"] = {
  "metadata": {
    ...
    "provider": "Groq",
    "developer": "Google",
    "description": "A smaller but efficient model for generating quick and coherent text.",
...
configurations["Mixtral 8x7B"] = {
  "metadata": {
    ...
    "provider": "Groq",
    "developer": "Mistral",
    "description": "An instruct model with a large context window for detailed outputs.",
...
configurations["Llama Guard 3 8B"] = {
  "metadata": {
    ...
    "provider": "Groq",
    "developer": "Meta",
    "description": "A secure and reliable model designed for guard-rail purposes.",
